...
class _AdvisorsScreenState extends ConsumerState<AdvisorsScreen> {
  ...
  void _navigateToAdvisorProfile(Map<String, dynamic> advisorData) {
    ...
    final advisor = Advisor(
      ...
      rating: 4.8,
      totalReviews: 150,
      totalClients: int.tryParse((advisorData['clientsHelped'] as String).replaceAll('+', '')) ?? 200,
      successRate: double.tryParse((advisorData['successRate'] as String).replaceAll('%', '')) ?? 94.0,
      averageReturn: 12.5,
      clientSatisfaction: 4.7,
      totalInvestmentValue: 50000000, // 50M RWF
      certifications: (advisorData['certifications'] as List<String>).map((cert) => Certification(
        name: cert,
